...
reportsRouter.get(
  "/getreports-all-vehicles/:user_uuid",
  reportsController.getVehicle
);

// This Api Get All Contacts For Reports
reportsRouter.get(
  "/getreports-all-contacts/:user_uuid",
  reportsController.getAllContacts
);

// This Api Create a Reports to the selected Vehicles
reportsRouter.post(
  "/createReports-all/:user_uuid",
  reportsController.createAllreport
);
